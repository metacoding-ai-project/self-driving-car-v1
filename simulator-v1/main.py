...
def test():
    ...
    while running:
        ...
        # 정보 패널 (반투명 배경)
        info_surface = pygame.Surface((env.screen.get_width(), 150))
        ...
        y_offset = 10
        texts = [
            ("🚗 자율주행 테스트 모드 - 최적 경로 찾기", font, (255, 255, 100)),
            (f"현재 행동: {current_action}", small_font, (255, 255, 255)),
